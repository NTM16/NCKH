    ...
    if bsheet.empty:
        ...
        with valuation:
            ...
            if selected_display_option == "Free Cash Flow":
                ...
                number3_str = st.text_input("Net Income:", value=formatted_net_income, placeholder="Type a number...")
                number3 = float(number3_str.replace(',', ''))
                ...
                number4_str = st.text_input("Operating Cash Flow:", value=formatted_operating_cash_flow,
                                            placeholder="Type a number...")
                number4 = float(number4_str.replace(',', ''))
